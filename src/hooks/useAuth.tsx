...
function AuthProvider({ children }: AuthProviderData) {
  ...
  async function signOut() {
    try {
      ...
      revokeAsync({ clientId: process.env.TWITCH_CLIENT_ID, token: userToken }, { revocationEndpoint: twitchEndpoints.revocation })
    } catch (error) {
    } finally {
      setUser({} as User)
      setUserToken("")
  ...
  useEffect(() => {
    api.defaults.headers['Client-Id'] = process.env.TWITCH_CLIENT_ID;
  }, [])
